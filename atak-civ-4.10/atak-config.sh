...
ln -s ~/atak/atak-civ/my-release-key.jks ~/atak/atak-civ/plugins/plugintemplate/app/my-release-key.jks

ln -s ~/atak/atak-civ/local.properties ~/atak/atak-civ/plugins/plugintemplate/local.properties
